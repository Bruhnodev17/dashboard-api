...
import { createTransactionSchema, getDashboardSchema, getFinancialEvolutionSchema, indexTransactionSchema } from "../database/dtos/transactions.dto";
...
transactionsRoutes.get("/financial-evolution", validator({
    ...
    type: ParamsType.QUERY,
}), controller.getFinancialEvoulution);
